...
const winners_controller_1 = require("./winners.controller");
...
exports.FundsModule = FundsModule = __decorate([
    (0, common_1.Module)({
        controllers: [funds_controller_1.FundsController, winners_controller_1.WinnersController],
        providers: [funds_service_1.FundsService, winners_service_1.WinnersService],
    })
], FundsModule);
